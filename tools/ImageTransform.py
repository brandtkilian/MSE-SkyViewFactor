...
class ImageTransform:
    ...
    def torify_image(self, image, interpolation=cv2.INTER_CUBIC, border_mode=cv2.BORDER_CONSTANT, border_value=0):
        assert image.shape[1] == self.width and image.shape[0] == self.height, "This Image transform instance cannot handle transformation for image of shape" + image.shape
